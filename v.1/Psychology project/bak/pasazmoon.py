...
def shoro():
        ...
        def GButton_944_command():
            exit()
        GButton_944_1=Button(root,font=("Times",10))
        GButton_944_1["bg"] = "#fe9d9d"
        GButton_944_1["fg"] = "#000000"
        GButton_944_1["justify"] = "center"
        GButton_944_1["text"] = "خروج کامل"
        GButton_944_1.place(x=730,y=0,width=70,height=25)
        GButton_944_1["command"] = GButton_944_command
        ...
        def move():
            ...
            if a<len(sc):
                ...
                def create_window():
                    ...
                    v_1=IntVar()
                    v_2=IntVar()
                    opt1=Checkbutton(new_window,text="بله",variable=v_1,
                    ...
                    ).place(x=550,y=450,width=100,height=35)

                    optn2=Checkbutton(new_window,text="خیر",variable=v_2,
                    activeforeground = "#fad400",
                    bg = "#00babd",
                    font=('Times',18),
                    fg = "#333333",
                    justify = "center",
                    relief="raised",
                    command=lambda:simp_check(2)).place(x=340,y=450,width=100,height=35)
