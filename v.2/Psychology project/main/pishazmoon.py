...
def shoro(client_data):
        ...
        signup_interface.button.configure(command=lambda:insert(signup_interface.entry_1.get(),signup_interface.entry_2.get(),client_data))

        data1=dict()

        def insert(client_name,client_id,client_data):
